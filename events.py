...
def __init__(self):
    self.events = [event_1(),event_2(),event_3()]
...
def random_event():
    if doom3 =1:
        ...
        chance.event = random.randint(1, 7)
        if chance.event == 7:
        #stop_time()
...
def event_3():
    ...
    if answer.lower() == "Ja" or "ja":
        ...
        "Der Mann freut sich über deine Antwort und zieht zugleich ins Dorf. Er wird schnell zum neuen Liebling\nund alle Dorfbewohner hängen an seinen Lippen.")
        doom3 = 1
    else:
